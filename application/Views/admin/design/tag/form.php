  ...
  <div class="col-lg-12">
    <div class="box">
      ...
      <div id="collapse3" class="body">
        <form action="#" class="form-horizontal" id="tagForm" onsubmit="return ">
           
          <div class="form-group">
            <label class="control-label col-lg-3">名称</label>
            <div class="col-lg-6">
              <input type="text" id="tag_name" name="tag_name" class="form-control col-lg-6">
            </div>
          </div>
         ...
         <!--  <div class="form-group">
            ...
            <div class="col-lg-6">
              <select name="tag_parent" id="tag_parent" class="form-control">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-6">
              <textarea id="tag_remark" name="tag_remark" class="form-control col-lg-6" rows="5"> </textarea>
            </div>
          </div>
