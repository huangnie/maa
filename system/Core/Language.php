...
class Language
{
    ...
    {
        /** lang file */
        $file = LANGUAGE_PATH . DIRECTORY_SEPARATOR .$code. DIRECTORY_SEPARATOR . $name. PHP_EX; 
        ...
        if (is_readable($file)) {
            ...
            /** display error */
            echo Error::display( 'Could not load language file ：' .$code. DIRECTORY_SEPARATOR . $name. PHP_EX );
            die;
        }
    }
